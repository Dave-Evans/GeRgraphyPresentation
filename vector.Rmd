...
Think like a table, each row (observation) is referred to as a _feature_.

![think like a table](img/table_concept.png)

The other data is often referred to as the _attribute table_ and or as _attribute data_.

Each row is one observation (one feature), this becomes important later, are we referring to individual features or to the entire geometry.
